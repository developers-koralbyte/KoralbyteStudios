          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
              ...
              <div className="pt-4 flex flex-col items-center gap-6">
                ...
                <p className="text-white/40 font-mono text-[10px] md:text-xs text-center border-t border-white/10 pt-6 w-full">Delivered in 5–7 business days. No commitment required. Or email us at connect@koralbyte.com</p>
              </div>
            </form>
          )}
        </div>
